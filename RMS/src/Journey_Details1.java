...
public class Journey_Details1 extends JFrame {
    ...
    public Journey_Details1() {
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                String source = (String)Journey_Details1.this.sourceComboBox.getSelectedItem();
                String destination = (String)Journey_Details1.this.destinationComboBox.getSelectedItem();

                try {
                    conn c = new conn();
                    String str = "select * from jrny_details where Source = '" + source + "' and Destination = '" + destination + "'";
                    ResultSet rs = c.s.executeQuery(str);
                    Journey_Details1.this.table.setModel(DbUtils.resultSetToTableModel(rs));
